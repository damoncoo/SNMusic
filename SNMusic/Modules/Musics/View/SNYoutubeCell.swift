...
public let SNYoutubeCellID = "SNYoutubeCellID"

class SNYoutubeCell: SNBaseTableViewCell {
    ...
    func setup() {
        ...
        self.channelLabel.snp.makeConstraints { (maker) in
    ...
    func fillWithData(music: SNYoutube) {
        
        self.titleLabel.text = music.title
        
        self.channelLabel.text = music.channelTitle
    }
